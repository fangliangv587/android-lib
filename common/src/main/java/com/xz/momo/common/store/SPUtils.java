...
import com.xz.momo.common.Utils;
import com.xz.momo.common.gson.XGson;
...
public final class SPUtils {
     ...
     * @param isCommit
     */
    public void put(@NonNull final String key, @NonNull final Object value, final boolean isCommit){
        String json = XGson.toJson(value);
        put(key,json,isCommit);
    }
     ...
     * @return
     */
    public  <T> T getObject(@NonNull final String key, @NonNull Class<T> cls){
        String json = getString(key, null);
        if (json == null){
            return null;
        }
        return XGson.fromJson(json,cls);
    }
